  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-[#F8F9FD] text-brand-navy-950 font-sans selection:bg-brand-gold-500 selection:text-white">
      ...
      <div className="hidden lg:flex lg:w-1/2 min-h-screen relative overflow-hidden bg-brand-navy-950 p-10 xl:p-14 flex-col justify-between select-none">
        ...
        {/* Bottom Trust Badge */}
        <div className="relative z-10 bg-white/[0.05] border border-white/[0.1] backdrop-blur-xl rounded-2xl p-4 shadow-2xl max-w-md flex items-center gap-3.5">
          ...
          <div>
            ...
            <div className="text-[11px] text-brand-navy-300">
      ...
      <div className="w-full lg:w-1/2 min-h-screen flex flex-col justify-between items-center p-6 sm:p-10 relative">
        ...
        <div className="w-full max-w-[480px] flex items-center justify-between pt-2">
        ...
        <div className="w-full max-w-[460px] bg-white rounded-3xl p-6 sm:p-8 shadow-[0_10px_40px_-15px_rgba(0,0,0,0.06)] border border-gray-100/80 my-auto">
          {/* Top Monogram Badge */}
          <div className="w-12 h-12 mx-auto rounded-2xl bg-[#FFF8F0] border border-[#FFE8D1] flex items-center justify-center mb-3 shadow-2xs">
            <span className="font-serif font-bold text-lg text-amber-700 tracking-tight">AR✦</span>
          </div>

          {/* Header Title */}
          <div className="text-center mb-4">
            <h1 className="text-xl sm:text-2xl font-bold text-gray-900 tracking-tight">Create Your Account</h1>
          ...
          <form onSubmit={handleRegister} className="space-y-3">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 text-xs rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#6342E8]/20 focus:border-[#6342E8] font-medium transition-all text-gray-900 placeholder:text-gray-400"
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2.5 text-xs rounded-xl border border-gray-200 bg-white focus:outline-none focus:ring-2 focus:ring-[#6342E8]/20 focus:border-[#6342E8] font-medium transition-all text-gray-900"
                >
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-9 py-2.5 text-xs rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#6342E8]/20 focus:border-[#6342E8] font-medium transition-all text-gray-900 placeholder:text-gray-400"
                  />
                  <button
                    type="button"
            ...
            <div className="pt-1">
              <label className="flex items-start gap-2 cursor-pointer select-none text-gray-600">
                <input
                  type="checkbox"
                  checked={agreeTerms}
